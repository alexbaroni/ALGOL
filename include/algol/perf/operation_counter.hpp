...
namespace algol {
  namespace perf {
    ...
    public:
      ...
      static Counter const& accesses() { return accesses_; }

      static Counter const& assignments() { return assignments_; }
      ...
      static Counter const& additions() { return additions_; }

      static Counter const& subtractions() { return subtractions_; }

      static Counter const& multiplications() { return multiplications_; }

      static Counter const& divisions() { return divisions_; }

      static Counter const& moduli() { return moduli_; }

      static Counter const& equal_comparisons() { return equal_comparisons_; }

      static Counter const& less_comparisons() { return less_comparisons_; }

      static Counter const& great_comparisons() { return great_comparisons_; }

      static Counter const& less_eq_comparisons() { return less_eq_comparisons_; }

      static Counter const& great_eq_comparisons() { return great_eq_comparisons_; }

      static Counter const& ands() { return ands_; }

      static Counter const& ors() { return ors_; }

      static Counter const& xors() { return xors_; }

      static Counter const& left_shifts() { return left_shifts_; }

      static Counter const& right_shifts() { return right_shifts_; }

      static Counter const& unary_plus() { return unary_plus_; }

      static Counter const& unary_minus() { return unary_minus_; }

      static Counter const& nots() { return nots_; }

      static Counter const& complements() { return complements_; }

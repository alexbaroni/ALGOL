...
using geometric_progession_infinite = algol::sequence::geometric_progression_infinite_seq<uint32_t>;
using geometric_progession_first_n = algol::sequence::geometric_progression_first_n_seq<uint32_t>;

class geometric_progession_fixture : public ::testing::Test {
protected:
    geometric_progession_infinite inf_seq{2, 3};
    geometric_progession_first_n first_n_seq{5, 2, 6};
};

TEST_F(geometric_progession_fixture, infinite) {
...
TEST_F(geometric_progession_fixture, first_n) {
    std::vector<uint32_t> val;

...
int main()
{
...

  {
    ...
    operation_counter::reset();
    stopwatch sw;
    selection_sort(std::begin(lst), std::end(lst));
    std::cout << sw;
    std::cout << "< " << operation_counter::less_comparisons() << " swaps " << operation_counter::swaps() << std::endl;
  ...
  {
    std::cout << std::endl << "Selection sort random order" << std::endl;
  ...
  {
    std::cout << std::endl << "Selection sort random order (STL)" << std::endl;
    std::array<operation_counter, 1000> arr;
    build_random_array(arr, rng);
    operation_counter::reset();
    stopwatch sw;

...
{
  algol::algorithms::sort::bogo_sort_random(std::begin(vec), std::end(vec));
  ASSERT_EQ(vec[0], -3);
...
{
  algol::algorithms::sort::bogo_sort_random(std::begin(str), std::end(str));
  ASSERT_EQ(str[0], 'A');
...
{
  algol::algorithms::sort::bogo_sort_random(std::begin(array), std::end(array));
  ASSERT_EQ(array[0], -3);
...
{
  algol::algorithms::sort::bogo_sort_deterministic(std::begin(vec), std::end(vec));
  ASSERT_EQ(vec[0], -3);
  ASSERT_EQ(vec, sorted_vec);
}
...
{
  algol::algorithms::sort::bogo_sort_deterministic(std::begin(str), std::end(str));
  ASSERT_EQ(str[0], 'A');
  ASSERT_EQ(str, sorted_str);
}
...
{
  algol::algorithms::sort::bogo_sort_deterministic(std::begin(array), std::end(array));
  ASSERT_EQ(array[0], -3);
  ASSERT_EQ(array, sorted_array);
}
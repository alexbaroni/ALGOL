...
int main ()
{
  ...
  std::cout << "Shell sort reverse order" << std::endl;
  {
    ...
    stopwatch sw;
    shell_sort(std::begin(arr), std::end(arr));
    std::cout << sw;
  ...
  }
  {
    ...
    std::array<operation_counter, BENCHMARK_SIZE> arr = build_reverse_array<operation_counter, BENCHMARK_SIZE>();
    operation_counter::reset();
    stopwatch sw;
    shell_sort(std::begin(arr), std::end(arr));
    std::cout << sw;
  ...
  {
    std::cout << std::endl << "1000 elements ciura gaps:" << std::endl;
    std::array<operation_counter, BENCHMARK_SIZE> arr = build_reverse_array<operation_counter, BENCHMARK_SIZE>();
    operation_counter::reset();
    stopwatch sw;
    shell_sort_ciura_gaps(std::begin(arr), std::end(arr));
    std::cout << sw;
    std::cout << "< " << operation_counter::less_comparisons() << " swaps " << operation_counter::swaps() << std::endl;
    assert(std::is_sorted(std::begin(arr), std::end(arr)));
  }
  ...
  {
    std::cout << std::endl << "Shell sort random order" << std::endl;
  ...
  {
    std::cout << std::endl << "Shell sort random order ciura gaps" << std::endl;
    std::array<operation_counter, BENCHMARK_SIZE> arr;
    build_random_array(arr, rng);
    operation_counter::reset();
    stopwatch sw;
  ...
  std::cout << std::endl << "Ciura 1000 elements:" << std::endl;
  {
    std::cout << std::endl << "sorted elements:" << std::endl;
    std::array<operation_counter, BENCHMARK_SIZE> arr;
    build_sorted_range(std::begin(arr), std::end(arr), -5);
  ...
  std::cout << std::endl << "Hibbard 1000 elements:" << std::endl;
  {
    std::cout << std::endl << "sorted elements:" << std::endl;
    std::array<operation_counter, BENCHMARK_SIZE> arr;
    build_sorted_range(std::begin(arr), std::end(arr), -5);
    operation_counter::reset();
    stopwatch sw;
    shell_sort_hibbard_gaps(std::begin(arr), std::end(arr));
    std::cout << sw;
    std::cout << "< " << operation_counter::less_comparisons() << " swaps " << operation_counter::swaps() << std::endl;
    assert(std::is_sorted(std::begin(arr), std::end(arr)));
  }
  ...
  }
  {
    ...
    operation_counter::reset();
    auto result = benchmark::run_n(BENCHMARK_RUNS, [&run_num, &array] () {
      shell_sort_hibbard_gaps(std::begin(array[run_num]), std::end(array[run_num]));
      ++run_num;
    });
    std::cout << benchmark::run_average(result);
    std::cout << "< " << operation_counter::less_comparisons() / BENCHMARK_RUNS
  ...
  std::cout << std::endl << "Sedgewick 1000 elements:" << std::endl;
  {
    std::cout << std::endl << "sorted elements:" << std::endl;
    std::array<operation_counter, BENCHMARK_SIZE> arr;
    build_sorted_range(std::begin(arr), std::end(arr), -5);
    operation_counter::reset();
    stopwatch sw;
    shell_sort_sedgewick_gaps(std::begin(arr), std::end(arr));
    std::cout << sw;
    std::cout << "< " << operation_counter::less_comparisons() << " swaps " << operation_counter::swaps() << std::endl;
    assert(std::is_sorted(std::begin(arr), std::end(arr)));
  }
  ...
  }
  {
    ...
    operation_counter::reset();
    auto result = benchmark::run_n(BENCHMARK_RUNS, [&run_num, &array] () {
      shell_sort_sedgewick_gaps(std::begin(array[run_num]), std::end(array[run_num]));
      ++run_num;
    });
    std::cout << benchmark::run_average(result);
    std::cout << "< " << operation_counter::less_comparisons() / BENCHMARK_RUNS

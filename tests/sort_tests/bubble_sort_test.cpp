...
{
  algol::algorithms::sort::bubble_sort_optimized(std::begin(vec), std::end(vec));
  ASSERT_EQ(vec[0], -3);
  ASSERT_EQ(vec, sorted_vec);
}
...
{
  algol::algorithms::sort::bubble_sort_optimized(std::begin(str), std::end(str));
  ASSERT_EQ(str[0], 'A');
  ASSERT_EQ(str, sorted_str);
}
...
{
  algol::algorithms::sort::bubble_sort_optimized(std::begin(array), std::end(array));
  ASSERT_EQ(array[0], -3);
  ASSERT_EQ(array, sorted_array);
}
...
{
  algol::algorithms::sort::bubble_sort_optimized(std::begin(lst), std::end(lst));
  ASSERT_EQ(lst, sorted_lst);
}

TEST_F(bubble_sort_fixture, fast_sort_vec)
{
  algol::algorithms::sort::bubble_sort_fast(std::begin(vec), std::end(vec));
  ASSERT_EQ(vec[0], -3);
  ASSERT_EQ(vec, sorted_vec);
}
...
{
  algol::algorithms::sort::bubble_sort_fast(std::begin(str), std::end(str));
  ASSERT_EQ(str[0], 'A');
  ASSERT_EQ(str, sorted_str);
}
...
{
  algol::algorithms::sort::bubble_sort_fast(std::begin(array), std::end(array));
  ASSERT_EQ(array[0], -3);
  ASSERT_EQ(array, sorted_array);
}
...
{
  algol::algorithms::sort::bubble_sort_fast(std::begin(lst), std::end(lst));
  ASSERT_EQ(lst, sorted_lst);
}
